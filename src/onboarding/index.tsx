        ...
        <div className="flex flex-col gap-6 items-center mt-7 w-full">
          <div className="w-[131px] h-[135px] rounded-sm overflow-hidden ml-[-8%]">
            <img
              ...
              alt="image"
              src="/Hayati-AI/images/onboarding/onboarding-3.png"
            />
          </div>
          <div className="flex flex-row items-center justify-around w-full">
            <div className="w-[131px] h-[135px] rounded-sm overflow-hidden mb-[-15%]">
              <img
                className="w-full h-full object-cover"
                alt="image"
                src="/Hayati-AI/images/onboarding/onboarding-1.png"
              />
            </div>
          ...
          <div className="flex flex-row items-center justify-around w-full">
            <div className="w-[131px] h-[135px] rounded-sm overflow-hidden">
              <img
                className="w-full h-full object-cover"
                alt="image"
                src="/Hayati-AI/images/onboarding/onboarding-2.png"
              />
            </div>
          ...
          <div className="mt-16 mb-12 w-full pt-3 px-8">
            <Sheet key={"bottom"}>
              <SheetTrigger asChild>
                <Button
                  variant={"secondary"}
                  className="w-full rounded-lg font-bold hover:bg-slate-50"
                >
                  Get Started
                </Button>
              </SheetTrigger>
              ...
              >
                ...
                <div className="grid gap-4 py-4">
                  <div className="border-b border-[#DFDFDF] pb-4">
                    <Button
                      variant={"link"}
                      className="text-black align-center justify-start pl-0 hover:no-underline focus:outline-none"
                    >
                      العربية
                    </Button>
                  </div>
                  <div className="border-b border-[#DFDFDF] pb-4">
                    <Button
                      variant={"link"}
                      className="text-black align-center justify-start pl-0 hover:no-underline"
                    >
                      English
                    </Button>
                  </div>
